...
const BestForeignMovie = () => {
  const [leftArrowVisible, setLeftArrowVisible] = useState(false);
  function scrollHorizontally() {
    const container = document.querySelector('#scrollerElement3');
  ...
  return (
    <P.BestForeignMovieContainer>
      
        <>
          <P.Categoria>Phyrexians</P.Categoria>
          ...
          <P.Scroller ref={myDivRef} id="scrollerElement3">
...
export default BestForeignMovie;
